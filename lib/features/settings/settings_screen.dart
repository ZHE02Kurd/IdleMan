      ...
      builder: (BuildContext builder) {
        ...
        return Container(
          ...
          child: Column(
            ...
            Widget _buildWheel(BuildContext context, theme, int min, int max, int selected, Function(int) onChanged, {required String label}) {
              return Column(
                children: [
